...
export const FALLBACK_DEFAULTS: Record<string, { provider: ProviderName; model: string }> = {
  ...
  evaluation: { provider: "anthropic", model: DEFAULT_ANTHROPIC_MODEL },
...
export const MODEL_DEFAULTS: ModelConfig = {
  ...
  adversarialProvider: "openai",
  adversarialModel: DEFAULT_OPENAI_MODEL,
...
export async function getModelConfig(): Promise<ModelConfig> {
  try {
    ...
    const base: ModelConfig = {
      ...
      adversarialProvider: (cfg["adversarialProvider"] ?? "openai") as ProviderName,
      adversarialModel: resolveModel("adversarialModel", "adversarialProvider", openaiModel),
