...
import { TrendingUp, GitBranch, Radio, Zap, ChevronDown, ChevronRight } from "lucide-react";
...
const VALID_TABS = ["timeline", "evolution", "live"] as const;
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      <PageHeader
        ...
        description="Visualize how the AI pipeline iteratively improves peace deal proposals through automated experimentation and self-improvement."
      />
