  ...
  return (
    <section className="border border-border/50 bg-card rounded-sm p-6 space-y-4">
      ...
      <p className="text-xs text-muted-foreground leading-relaxed">
        This is the current highest-scoring AI-generated peace deal proposal
        {data.totalDeals ? <> out of <span className="font-semibold text-foreground">{data.totalDeals}</span> deals generated by AutoPeace so far</> : null}
        {createdDate ? <>, proposed based on the state of the world on <span className="font-semibold text-foreground">{createdDate}</span></> : null}.
      </p>
