    ...
    <div className="max-w-5xl mx-auto space-y-10 animate-fade-in pb-12">
      ...
      <div className="prose prose-invert prose-lg max-w-none text-muted-foreground space-y-8">
        ...
        <Card className="p-8" id="task-b">
          ...
          <p className="mt-4">
            Architecture selection uses a dual mechanism: <strong>sequential cycling</strong> advances through all 8 architectures in order, ensuring every architecture gets equal exploration time; and <strong>stall-triggered randomization</strong> switches to a randomly selected architecture when 3 or more consecutive cycles fail to improve scores. This prevents the optimization loop from getting stuck in local optima and ensures the system explores fundamentally different negotiation paradigms — from conventional frameworks to radical creative approaches — rather than favoring any subset.
          </p>
